  ...
  return (
    <div class="dark:bg-zinc-800 fixed z-10 ">
      ...
      <nav
        ...
        className="left-0 top-0 z-50 h-screen w-[90px] -translate-x-full overflow-hidden bg-zinc-800 shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] data-[te-sidenav-hidden='false']:translate-x-0"
      ...
      >
        ...
        >
          <li className="relative my-4">
            <NavLink
              to={user?.role==="teacher"? "/createExam" : "/courses"}
            ...
            >
              <span className="mx-auto motion-reduce:transition-none [&>svg]:h-7 [&>svg]:w-7 [&>svg]:fill-gray-300 [&>svg]:transition [&>svg]:duration-300 [&>svg]:ease-linear group-hover:[&>svg]:fill-white group-focus:[&>svg]:fill-white group-active:[&>svg]:fill-white group-data-[te-sidenav-state-focus]:[&>svg]:fill-white">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <g fill="#FFFFFF">
                      <path d="M5 13.1V16c0 3 2.6 4 7 4s7 0 7-3v-3.9L12 16l-7-2.9z"></path>
                      <path d="M22 15V9.8l2-.8-12-5L0 9l12 5 9-3.8V15c-1 .2-1 1.1-1 2v3h3v-3c0-.9 0-1.7-1-2z"></path>
                    </g>
                  </svg>
                </svg>
              </span>
          ...
          <li className="relative my-4">
            <NavLink
            to={user?.role==="teacher"? "/createContent" : "/"}
              className="group flex h-12 cursor-pointer items-center truncate rounded-[5px] px-6 py-4 text-[0.875rem] text-gray-300 outline-none transition duration-300 ease-linear hover:bg-white/10 hover:outline-none focus:bg-white/10 focus:outline-none active:bg-white/10 active:outline-none data-[te-sidenav-state-focus]:outline-none motion-reduce:transition-none"
              data-te-sidenav-link-ref
            >
              <span className="mx-auto motion-reduce:transition-none [&>svg]:h-7 [&>svg]:w-7 [&>svg]:fill-gray-300 [&>svg]:transition [&>svg]:duration-300 [&>svg]:ease-linear group-hover:[&>svg]:fill-white group-focus:[&>svg]:fill-white group-active:[&>svg]:fill-white group-data-[te-sidenav-state-focus]:[&>svg]:fill-white">
            ...
            >
              <span className="mx-auto motion-reduce:transition-none [&>svg]:h-7 [&>svg]:w-7 [&>svg]:fill-gray-300 [&>svg]:transition [&>svg]:duration-300 [&>svg]:ease-linear group-hover:[&>svg]:fill-white group-focus:[&>svg]:fill-white group-active:[&>svg]:fill-white group-data-[te-sidenav-state-focus]:[&>svg]:fill-white">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <g fill="#FFFFFF">
                      <path d="M20.8 6.2L17 10V7c0-.6-.4-1-1-1H3c-.6 0-1 .4-1 1v10c0 .6.4 1 1 1h13c.6 0 1-.4 1-1v-3l3.8 3.8c.4.4 1.2.1 1.2-.5V6.7c0-.6-.8-.9-1.2-.5z"></path>
                    </g>
                  </svg>
                </svg>
              </span>
          ...
          <li>
            <div onClick={logout} className='text-white text-center overflow-hidden transition duration-300 ease-in-out hover:bg-slate-100 hover:bg-opacity-10 cursor-pointer'>
              Logout
              <img className='mx-auto  rounded-lg py-3 px-8 w-full' src='/logout.png' alt=''/>
            </div>
          </li>
        </ul>
      </nav>
